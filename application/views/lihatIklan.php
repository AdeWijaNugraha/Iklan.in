...
<div class="container-fluid">
  <div class="row content">
    ...
    <br>
      <center>
      <img src="<?php echo base_url('assets') ?>/img/a.png" class="img-square" width="120" height="120">
      </center>
      <h4>Dashboard</h4>
      <ul class="nav nav-pills nav-stacked" >
        <li><a href="lihatMember">Lihat member</a></li>
        <li style=""><a href="<?php echo base_url("index.php") ?>">Back to Home</a></li>
              ...
              <ul class="nav nav-tabs ">
                ...
                <div class="btn-group nav navbar-nav navbar-right">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="ascending">Nama  : A - Z</a></li>
                           ...
                           <div class="col-sm-3" >  
                            ...
                            <?php if($barang->status_iklan == "verifikasi"){ ?>
                                          <div class="panel " style="border-radius: 0px; border: 1px solid #A88645;" id="panel"> 
                                            <a href="<?php echo base_url('barang/satu/'.$barang->id_iklan); ?>">
